...
{
    public class SharedStyleLibraryMap
    {
        private static ILogger Log => Logger.Log.ForContext(typeof(SharedStyleLibraryMap));
        ...
        public static FileInfo File
        {
            get
            {
                ...
                _styleLibraryMap = new FileInfo(Path.Combine(Shared.Directory.FullName, STYLE_LIBRARY__MAP));
                return _styleLibraryMap;
            }
        }
    }
